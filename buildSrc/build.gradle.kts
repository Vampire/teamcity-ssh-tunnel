...
dependencies {
    ...
    implementation(gradlePlugin("com.github.rodm.teamcity-environments:1.2"))
    implementation(gradlePlugin("com.github.rodm.teamcity-common:1.2"))
    implementation(gradlePlugin("com.github.rodm.teamcity-agent:1.2"))
    implementation(gradlePlugin("com.github.rodm.teamcity-server:1.2"))
